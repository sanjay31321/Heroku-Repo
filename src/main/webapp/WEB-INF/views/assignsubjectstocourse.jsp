	...
	<c:set var="role" value="${loggedInUserROLE}"/>
		...
		<div class="margin-left-right">
			<ul class="breadcrumb">
				...
				<li>
					<a href="#"><spring:message code="app.subject.assign.to.course" /></a>
				</li>
			</ul>
		</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form:form commandName="course">				
							<div class="table-responsive">
								<h4 class="sub-header">${course.name}</h4><hr/>
								<table class="table table-striped">
									...
									<tbody>
			            				<c:forEach items="${subjectList}" var="subject">
											<c:forEach items="${couseSubjectList}" var="course_subject">
												<c:if test="${subject.id == course_subject.subject.id}">
													<tr>
