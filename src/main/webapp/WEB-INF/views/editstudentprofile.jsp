	...
	<tiles:putAttribute name="body">
		...
		<div class="margin-left-right">
			<ul class="breadcrumb">
				...
				<li>
					<a href="editstudentprofile.html?email=${loggedInUserEMAIL}"><spring:message code="app.breadcrumb.student.profile.edit" /></a>
				</li>
			</ul>
		</div>
					...
					<form:form commandName="user">
						<div class="row">
							<div class="col-sm-8">
								...
								<div class="row">
									<div class="col-sm-4">
										<label for="course"><spring:message code="app.panel.course" /></label>
									</div>
									<div class="col-sm-7">
										<input Class="form-control" name="course" value="${loggedInUserCOURSE}" disabled="true"/>
									</div>
								</div>
